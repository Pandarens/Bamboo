...
| `bamboo-store` | персистентность, SQLite | уровни L2 и L3, история SMART |
| `bamboo-etw` | трассировка процессов | видеорегистратор, короткоживущие процессы |
| `bamboo-policy` | что можно делать и с чем | уровни риска, белые списки, профили |
...
| `bamboo-ipc` | протокол агент-брокер | сообщения, кадрирование, правила канала |
...
Ещё не начато: ETW (`bamboo-etw`), политики и действия (`bamboo-policy`,
`bamboo-actuate`), журнал (`bamboo-journal`), брокер и IPC (`bamboo-service`,
`bamboo-ipc`).
